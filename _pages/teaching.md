...
nav: true
nav_order: 3
display_categories: [Electrical and Computer Engineering (ECE), Computer Science and Engineering (CSE), Cognitive Science (COGS), Mathematics (MATH), Physics (PHYS), Other]
horizontal: false
---
